"""lightop vendor: moe_quant_group_gemm_up
...
@ProviderRegistry.register_vendor_impl("moe_quant_group_gemm_up", "lightop")
class LightopMoeQuantGroupGemmUpOp(_UnifiedLightopMoeQuantGroupGemmOp):
    pass