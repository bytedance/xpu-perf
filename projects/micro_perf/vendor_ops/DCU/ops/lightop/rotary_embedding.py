"""
Lightop implementation of RotaryEmbedding, following the style of VllmRotaryEmbeddingOp in llm_ops.
"""
...
try:
    ...
    @ProviderRegistry.register_vendor_impl("rotary_embedding", "lightop")
